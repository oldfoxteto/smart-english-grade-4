// Mobile Testing Guide - Complete Testing Instructions
...
export const mobileTestingGuide: TestPage[] = [
  ...
  // Compatibility Testing
  {
    ...
    testSteps: [
      ...
      },
      {
        ...
        expected: 'All features should work correctly',
        arabicExpected: 'يجب أن تعمل جميع المميزات بشكل صحيح',
        instructions: '1. Open in Firefox mobile\n2. Test all features\n3. Check for Firefox-specific issues\n4. Verify add-on compatibility',
        arabicInstructions: '1. افتح في فايرفوكس للموبايل\n2. اختبر جميع المميزات\n3. تحقق من مشاكلات فايرفوكس\n4. تحقق من توافق الإضافات'
      }
    ],
  ...
  // Accessibility Testing
  {
    ...
    description: 'Test screen reader accessibility',
        arabicDescription: 'اختبار إمكانية الوصول لقارئ الشاشة',
